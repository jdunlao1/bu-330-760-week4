...
agent = Agent(
    ...
    system_prompt=(
        ...
        "Always use the calculator tool for ANY math, even multi-step problems. Break problems into steps and compute each step using the calculator. "
...
def main():
    ...
    for i, question in enumerate(questions, 1):
        ...
        time.sleep(0.5)  # Add a short delay between questions for readability
